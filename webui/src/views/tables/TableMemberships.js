...
const TableMemberships = () => {
  ...
  const fetchMembershipData = useCallback(async () => {
    setLoading(true);
    try {
      const response = await axios.get(`http://${themeConfig.apiUrl}/api/membership-data`, {
        headers: {
  ...
  const handleAdd = () => {
    console.log('Add Membership Data button clicked');
  };
  ...
  return (
    <MaterialTable
      ...
      columns={[
        ...
        { title: 'Gym Member ID', field: 'gym_member_id', align: 'left' },
        { title: 'Membership Plan ID', field: 'membership_plan_id', align: 'left' },
        { title: 'Start Date', field: 'start_date', align: 'right', type: 'datetime' },
        { title: 'End Date', field: 'end_date', align: 'right', type: 'datetime' },
          ...
          render: rowData => (
            <Collapse timeout='auto' unmountOnExit>
              <Box className={classes.detailPanel}>
                <Typography className={classes.detailTitle}>Membership Data Details</Typography>
                <TableContainer>
                  <Table size='small' aria-label='membership data details'>
                    <TableBody>
                      <TableRow>
                        <TableCell>
                          <strong>ID:</strong>
